...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(187, 3, 3),
			Second = Color3.fromRGB(11, 7, 233),
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Key Library"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "key Library"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "https://www.roblox.com/library/12112172299/wasa"
